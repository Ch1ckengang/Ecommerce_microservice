...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "cart_service.auth.ServiceJWTAuthentication",
    ),
    ...
    "PAGE_SIZE": 10,
    "EXCEPTION_HANDLER": "cart_service.api.custom_exception_handler",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "E-commerce Cart Service API Documentation",
    "VERSION": "1.0.0",
