...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "payment_service.auth.ServiceJWTAuthentication",
    ),
    ...
    "PAGE_SIZE": 10,
    "EXCEPTION_HANDLER": "payment_service.api.custom_exception_handler",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "E-commerce Payment Service API Documentation",
    "VERSION": "1.0.0",
