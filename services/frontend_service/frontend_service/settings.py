...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^j(99h$2pq%cx*bt@a&4hmx#c8rr6_7n1fnb$+(fujnr3r$=xs')
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD', 'frontend_password'),
...
CORS_ALLOWED_ORIGINS = [
    origin.strip()
    for origin in os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:8007,http://127.0.0.1:8007').split(',')
    if origin.strip()
]
