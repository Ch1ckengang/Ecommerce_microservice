...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "order_service.auth.ServiceJWTAuthentication",
    ),
    ...
    "PAGE_SIZE": 10,
    "EXCEPTION_HANDLER": "order_service.api.custom_exception_handler",
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "E-commerce Order Service API Documentation",
    "VERSION": "1.0.0",
